...
หน้าคำขอ (ทั้ง Admin และ User) **แยกเป็นขั้นตอนที่ 1–7 ตามตารางนี้** ไม่ใช่กองเดียว: แถบขั้นตอนด้านบนบอกจำนวน/มูลค่า
และจุดแดง "รอคุณ" ของแต่ละขั้น (กดเพื่อดูเฉพาะขั้นนั้น) · แต่ละกลุ่มมีคำอธิบายว่า**ตอนนี้ต้องทำอะไร** ซึ่งต่างกันตามบทบาท
เช่น ขั้น 4 Admin เห็น "ใส่เลข PR/PO รายชิ้น + กำหนดส่ง" ส่วน User เห็น "อนุมัติแล้ว รอฝ่ายจัดซื้อออก PR/PO" · ย่อ/กางได้ทีละขั้น
